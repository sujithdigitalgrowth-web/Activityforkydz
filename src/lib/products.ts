...
export const products: Product[] = [
  ...
  },
  {
    ...
    longDescription:
      "Dive into the Oceans & Sea Life Coloring Pack — 52 printable pages of dolphins, turtles, octopuses, clownfish and dozens more creatures that live under the waves, plus a two-page coral reef scene to color as one big picture. Each creature is paired with its name in simple English, making it an easy way to build ocean vocabulary while coloring. Designed for children aged 3–6, this printable sea life coloring pack is instant-download only: no app, no login, just a PDF you can print at home or at any print shop. It's a natural pairing with an aquarium visit, a beach trip, or a rainy afternoon at the table. Download once, print as many times as you like.",
    relatedSlugs: ["animal-friends", "trees-and-plants"],
    seoTitle: "Oceans & Sea Life Coloring Pack — Printable PDF for Kids",
    seoDescription:
      "52-page printable ocean animals coloring pack for kids ages 3-6. Dolphins, turtles, octopuses and more, with name labels. Instant PDF download.",
  },
  {
  ...
  },
  {
    ...
    seoDescription:
      "52-page printable trees and plants coloring pack for kids ages 3-6, with a seed-to-tree growth sequence. Instant PDF download.",
  },
  {
  ...
  },
  {
    ...
    whyItMatters: [
      "Eases in gently for ages 3-6, a step before the more advanced Letters and Words pack",
    ...
    seoDescription:
      "54-page printable A-Z activity book for kids ages 3-6. Letter recognition, tracing, matching and colouring. Instant PDF download.",
  },
  {
    slug: "my-first-lines",
    ...
    seoDescription:
      "27-page printable pre-writing workbook for kids ages 1-3, with line, curve and pattern tracing practice. Instant PDF download.",
  },
  {
  ...
  {
    slug: "cut-and-paste-alphabet",
    title: "Cut & Paste Alphabet Activity Book",
    cardTitle: "Cut & Paste Alphabet Activity",
    categoryLabel: "Cut & Paste Alphabet",
    category: "learning",
    tagline: "26 letters, 1 cut sheet + 1 paste sheet each, 5 pictures a letter",
    price: 99,
    pageCount: 82,
    ageRange: "3-6 years",
    accent: "from-rose-100 to-pink-50",
    emoji: "✂️",
    image: "/categories/Cut%20and%20Paste%20Alphabet%20Activity.png",
    pdfFile: "Activity-For-Kydz-Cut-And-Paste-Branded.pdf",
    rating: 4.5,
    purchaseCount: 0,
    description:
      "A cut-and-paste alphabet pack built letter by letter — every letter from A to Z gets its own cut sheet of 5 pictures and a facing paste sheet, so scissor practice and letter recognition happen on the same page.",
    whatsInside: [
      "82 pages: one cut sheet + one paste sheet for every letter, A to Z (52 sheets)",
      "5 child-safe picture cut-outs per letter — 130+ pictures in total",
      "Extra practice pages at the back for letters that need another go",
    ],
    whyItMatters: [
      "Builds fine motor and scissor control alongside letter-picture recognition",
      "One letter a day is a natural, low-pressure pace",
      "Every finished page pairs a letter with real objects a child already knows",
    ],
    relatedSlugs: ["cut-stick-and-make", "atoz-activity", "letters-and-words"],
    seoTitle: "Cut & Paste Alphabet Activity Book — Printable PDF for Kids",
    seoDescription:
      "82-page printable cut-and-paste alphabet pack for kids ages 3-6. One cut sheet and one paste sheet per letter, A to Z. Instant PDF download.",
  },
  {
    slug: "daily-practice-bundle",
    title: "Daily Practice Worksheet Bundle: 30 Days, 30 Skills",
    cardTitle: "Daily Practice Bundle (30 Days)",
    categoryLabel: "Daily Practice Bundle",
    category: "learning",
    tagline: "One worksheet a day for 30 days — tracing, numbers, words, patterns and more",
    price: 79,
    pageCount: 31,
    ageRange: "3-6 years",
    accent: "from-pink-100 to-rose-50",
    emoji: "🗓️",
    image: "/categories/Daily%20Practice%20Bundle.png",
    pdfFile: "Activity-For-Kydz-Daily-Practice-Bundle-Ages-4-7.pdf",
    rating: 4.5,
    purchaseCount: 0,
    description:
      "A 30-day worksheet routine that grows with your child — starting with tracing and colours for a 3-year-old, moving through alphabet, numbers and patterns, and finishing with sight words, addition and story sequencing for a 6-7 year old.",
    whatsInside: [
      "30 daily worksheets, one skill a day, plus an age guide on the cover",
      "Age 3: colours, big-small, tracing lines. Age 4: alphabet A-Z, numbers 1-10, patterns, matching",
      "Age 5: sight words, CVC words, counting, mazes, dot-to-dot. Age 6-7: addition, subtraction, story sequence, revision",
    ],
    whyItMatters: [
      "A ready-made daily routine — 20 minutes, no planning required",
      "Spans four age bands, so it keeps working as your child grows",
      "Mixes tracing, counting, reading and coloring so no single skill gets boring",
    ],
    relatedSlugs: ["letters-and-words", "numbers-and-counting-mats", "atoz-activity"],
    seoTitle: "Daily Practice Worksheet Bundle — 30 Days, 30 Skills (Printable PDF)",
    seoDescription:
      "31-page printable daily worksheet bundle for kids ages 3-6. 30 days, 30 skills — tracing, alphabet, numbers, sight words, patterns and more. Instant PDF download.",
  },
  {
    slug: "shapes-activity-book",
    title: "Shapes Activity Book: Tracing, Matching and Patterns",
    cardTitle: "Shapes Activity Book",
    categoryLabel: "Shapes",
    category: "learning",
    tagline: "10 shapes to learn, trace, match, complete and pattern",
    price: 99,
    pageCount: 62,
    ageRange: "3-6 years",
    accent: "from-violet-100 to-purple-50",
    emoji: "🔷",
    image: "/categories/Shapes%20activity%20Book.png",
    pdfFile: "ActivityForKydz_Shapes_Activity_Book.pdf",
    rating: 4.5,
    purchaseCount: 0,
    description:
      "A shape-by-shape activity book covering circle through star — each shape gets an intro page, then tracing, 'find the two that match', 'draw the missing part' and pattern-completion pages built around it.",
    whatsInside: [
      "10 shapes introduced one at a time: circle, triangle, hexagon, diamond, oval, rectangle, pentagon, square, heart and star",
      "A tracing page, a matching page and a 'draw the missing part' page for every shape",
      "Pattern-completion pages mixing shapes together",
    ],
    whyItMatters: [
      "Shape recognition is an early-maths building block most alphabet-first packs skip",
      "Matching and 'spot the pair' pages build visual discrimination, not just naming",
      "Pattern pages give an easy first taste of 'what comes next' logic",
    ],
    relatedSlugs: ["numbers-and-counting-mats", "big-book-of-comparisons"],
    seoTitle: "Shapes Activity Book — Printable Tracing & Matching PDF for Kids",
    seoDescription:
      "62-page printable shapes activity book for kids ages 3-6. Tracing, matching, missing-parts and pattern pages for 10 shapes. Instant PDF download.",
  },
  {
    slug: "a-hundred-mazes",
    title: "A Hundred Mazes: Six Levels, From Very Easy to Very Hard",
    cardTitle: "A Hundred Mazes",
    categoryLabel: "A Hundred Mazes",
    category: "learning",
    tagline: "100 computer-solved mazes across 6 levels, green dot to blue dot",
    price: 79,
    pageCount: 50,
    ageRange: "5-9 years",
    accent: "from-blue-100 to-indigo-50",
    emoji: "🧩",
    image: "/categories/Hundred%20Mazes.png",
    pdfFile: "activityforKydz-A-Hundred-Mazes.pdf",
    rating: 4.6,
    purchaseCount: 0,
    description:
      "One hundred mazes, every single one solved by computer before printing so there's always a way through — six levels running from grids small enough for a four-year-old to ones that hold a ten-year-old for a quarter of an hour.",
    whatsInside: [
      "100 mazes across 6 levels: Getting Started, Warming Up, Shapes, Getting Tricky, Long Way Round, The Hard Ones",
      "Every maze runs green dot to blue dot, in squares, diamonds, circles, hearts and stars",
      "A full answer key with the shortest route and step count for every maze",
    ],
    whyItMatters: [
      "Every maze is verified to have exactly one route, so persistence always pays off",
      "Dead ends teach planning and revising a plan — the same move needed for tricky maths later",
      "Six levels mean the same book can be handed to a 4-year-old or an 11-year-old",
    ],
    relatedSlugs: ["one-right-answer", "time-patterns-and-shapes"],
    seoTitle: "A Hundred Mazes — Printable Maze Book for Kids (PDF)",
    seoDescription:
      "50-page printable maze book for kids ages 5-9. 100 mazes across 6 levels with a full answer key. Instant PDF download.",
  },
  {
    slug: "one-right-answer",
    title: "One Right Answer: Sudoku and Logic Puzzles for Children",
    cardTitle: "One Right Answer: Sudoku & Logic",
    categoryLabel: "Sudoku & Logic Puzzles",
    category: "learning",
    tagline: "100 sudoku and logic puzzles, every one proved to have exactly one solution",
    price: 79,
    pageCount: 50,
    ageRange: "5-9 years",
    accent: "from-sky-100 to-blue-50",
    emoji: "🔢",
    image: "/categories/One%20Right%20Answer.png",
    pdfFile: "activityforKydz-One-Right-Answer.pdf",
    rating: 4.6,
    purchaseCount: 0,
    description:
      "A sudoku and logic puzzle book that starts small — 4x4 grids a five-year-old can finish, and a shapes version for anyone who finds numbers off-putting — before building up to 6x6 sudoku, odd-one-out, number sequences and real deduction puzzles.",
    whatsInside: [
      "100 puzzles: sudoku with numbers, sudoku with shapes, odd one out, number sequences and deduction puzzles",
      "Starts at 4x4 sudoku and builds up to 6x6 and multi-clue deduction",
      "A full answer key at the back, every puzzle proved to have exactly one solution",
    ],
    whyItMatters: [
      "Sudoku gives kids the rare feeling of knowing an answer is right without being told",
      "A shapes version removes the number barrier for kids who find digits off-putting",
      "Every grid was computer-checked so no child is marked wrong on a broken puzzle",
    ],
    relatedSlugs: ["a-hundred-mazes", "big-book-of-comparisons"],
    seoTitle: "One Right Answer — Sudoku & Logic Puzzles for Kids (Printable PDF)",
    seoDescription:
      "50-page printable sudoku and logic puzzle book for kids ages 5-9. 100 puzzles with a full answer key. Instant PDF download.",
  },
  {
    slug: "wait-what-animal-facts",
    title: "Wait, What? 45 Fun Facts About Animals",
    cardTitle: "Wait, What? Animal Facts",
    categoryLabel: "Animal Facts",
    category: "learning",
    tagline: "15 animals, 3 facts each, plus a quiz at the back",
    price: 79,
    pageCount: 28,
    ageRange: "5-9 years",
    accent: "from-lime-100 to-green-50",
    emoji: "🦒",
    image: "/categories/Wait%20what%20Animal%20Facts.png",
    pdfFile: "activityforKydz-Wait-What-Animal-Facts.pdf",
    rating: 4.6,
    purchaseCount: 0,
    description:
      "A read-aloud fact book, not a worksheet book — fifteen animals from elephants to honeybees, three facts each, with one 'wait, what?' fact per page odd enough that kids will want to tell somebody, and a ten-question quiz at the back.",
    whatsInside: [
      "15 animals across four groups: On Land, In the Sea, In the Air, and Small but Mighty",
      "45 facts total — every page leads with one big surprising number or word",
      "A 10-question quiz with an answer page, best tried a week after reading",
    ],
    whyItMatters: [
      "Reading for fun, not for a worksheet — good for car rides and bedtime alike",
      "The 'guess before you read' format turns facts into a game, not a lecture",
      "Every fact is real and checkable, with no numbers exaggerated for effect",
    ],
    relatedSlugs: ["reading-comprehension", "animal-friends"],
    seoTitle: "Wait, What? 45 Fun Animal Facts — Printable Reading Book for Kids",
    seoDescription:
      "28-page printable animal facts reading book for kids ages 5-9. 15 animals, 45 facts and a quiz at the back. Instant PDF download.",
  },
];
